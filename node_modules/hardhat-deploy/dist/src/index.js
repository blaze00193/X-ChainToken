...
function initCompanionNetworks(hre) {
    ...
    for (const name of Object.keys(hre.network.companionNetworks)) {
        ...
        network.provider = new lazy_initialization_1.LazyInitializationProviderAdapter(() => {
            return construction_1.createProvider(hre.config, networkName, hre.artifacts);
        });
